...
export default function Hero() {
  return (
    <section id="inicio" className="relative overflow-hidden bg-surface pb-20 pt-14 sm:pt-20 lg:pb-28 lg:pt-24">
      ...
      <Container className="grid items-center gap-14 lg:grid-cols-[45%_55%] lg:gap-10">
        <FadeIn className="flex flex-col items-start gap-6">
          ...
          <p className="text-balance text-base leading-relaxed text-ink">
        ...
        <FadeIn delay={150} className="relative">
          <div className="relative mx-auto aspect-[4/5] w-full max-w-[16rem] overflow-hidden rounded-[2rem] bg-gradient-to-br from-navy via-navy to-blue-2/60 shadow-[0_30px_60px_-20px_rgba(15,23,42,0.45)] sm:max-w-xs lg:max-w-sm">
            ...
            <div className="absolute -right-6 -top-6 h-24 w-24 rounded-full bg-blue-2/20 blur-2xl" />
