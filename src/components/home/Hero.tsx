    ...
    <section id="inicio" className="relative overflow-hidden bg-background pb-20 pt-14 sm:pt-20 lg:pb-28 lg:pt-24">
      ...
      <Container className="grid items-center gap-14 lg:grid-cols-[45%_55%] lg:gap-10">
        <FadeIn className="flex flex-col items-start gap-6">
          ...
          <h1 className="text-balance text-4xl font-extrabold leading-[1.1] text-primary sm:text-5xl lg:text-[3.4rem]">
            Hola, soy
            <br />
            <span className="text-secondary underline-scribble">Profe Jesús Álvarez</span>
          </h1>

          <p className="text-balance text-lg font-medium text-muted sm:text-xl">
        ...
        <FadeIn delay={150} className="relative">
          <div className="relative mx-auto aspect-[4/5] w-full max-w-[16rem] overflow-hidden rounded-[2rem] bg-gradient-to-br from-primary to-primary-dark shadow-[0_30px_60px_-20px_rgba(15,23,42,0.45)] sm:max-w-xs lg:max-w-sm">
            ...
            <div className="absolute -bottom-10 -left-6 h-28 w-28 rounded-full bg-accent/40 blur-2xl" />
            <div className="absolute left-1/2 top-[30%] h-32 w-32 -translate-x-1/2 -translate-y-1/2 rounded-full bg-accent/30 blur-2xl" />
