      ...
      <Container>
        <FadeIn className="mx-auto flex max-w-3xl flex-col items-center gap-6 rounded-xl border border-line bg-white shadow-[0_4px_6px_-1px_rgb(0_0_0/0.1)] px-6 py-12 text-center sm:px-14">
          <img
            ...
            height={80}
          />
          <span className="text-xs font-bold uppercase tracking-[0.18em] text-secondary">Detrás del proyecto</span>
          <p className="text-balance text-lg leading-relaxed text-muted/80 sm:text-xl">
